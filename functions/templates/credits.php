...
<div id="credits"><span class="credit"><?php $fullsingle_credit_pro = wp_kses_post(get_option( 'fullsingle_credit_pro', '<a href=\"https://onepagelove.com/fullsingle\">Built using FullSingle</a>' )); echo $fullsingle_credit_pro; ?></span></div>