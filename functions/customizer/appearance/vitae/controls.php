...
$wp_customize->add_setting(    'fullsingle_setting_vitae_extras', array(
    'default'               => ' ',
    'transport'             => 'postMessage',
    'sanitize_callback'     => 'fullsingle_setting_vitae_extras_sanitize',        
));

function fullsingle_setting_vitae_extras_sanitize( $input ) {
    return striptags($input ) ;
}

$wp_customize->add_control(    'fullsingle_setting_vitae_extras', array(
    'section'               => 'fullsingle_section_vitae', 
    'label'                 => ' ',
    'priority'              => 102,
    'description'           => '<span style="font-style: normal">
    <p>Unlock these Vitae Customizer options when upgrading to <a href="/wp-admin/customize.php?autofocus[section]=fullsingle_section_support">FullSingle Pro</a>:</p>
    <ul>        
        <li>🔒 Work & Network Background Color</li>         
        <li>🔒 Contact Background Color</li> 
        <li>🔒 Copyright Background Color</li>           
    ...
    <h2>Useful Vitae Links:</h2>
    <ul>        
    <li><b style="display: inline-block; width: 80px;">Setup:</b>       <a href="https://onepagelove.com/go/fullsingle-setup-mvitae">Watch Video</a></li>
    <li><b style="display: inline-block; width: 80px;">Reference:</b>   <a href="https://demo.onepagelove.com/fullsingle/vitae-layout/">See Demo</a></li>     
